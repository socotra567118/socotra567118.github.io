---
title: 프로그래머스 - 82612번 부족한 금액 계산하기
date: 2024-10-20 05:32:00 +0900
...
[82612번 부족한 금액 계산하기](https://school.programmers.co.kr/learn/courses/30/lessons/82612)
...
### 1. 접근 방법
- 반복문을 이용하여 이용료의 합을 구한다.
- 이용료의 합이 가지고 있는 금액보다 많은지 적은지 판별한 후, 적으면 0을 반환한다.
...
def solution(price, money, count):
    ...
    for time in range(1, count + 1):
        need_money += time * price

    return need_money - money if need_money - money > 0 else  0
```

### 개선할 점
- 이용료의 합을 등차 수열의 합으로 보고 코드를 줄일 수 있다. 하지만, 가독성은 떨어진다.
